...
function CadastroPage() {
  ...
  return (
    <section>
      ...
      <div className="flex flex-col w-full h-[800px] md:h-[500px] flex justify-center items-center">
        ...
        <div className="flex flex-col w-[80%] h-full md:flex-wrap md:items-center ">
          ...
          <div className="flex flex-col w-full md:w-[40%]">
            ...
            <div className="flex font-normal items-center text-[12px] mt-[5px] mb-[15px]">
              <CheckboxCad text="&#32; Desejo receber notificações e novidades por e-mail" />
            </div>
      ...
      <ModalCad state={isClose} handleActive={handleCloseMod} />
    </section>
  );
}
