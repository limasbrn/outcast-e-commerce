...
function ModalCad(props) {
  ...
  return (
    state && (
      <div className="flex absolute top-0 left-0 h-[170%] w-[100%] bg-black/25 justify-center items-center">
        <div className="flex h-[270px] w-[350px] bg-white justify-center items-center rounded-[5px]">
          <div className="flex flex-col h-[90%] w-[90%] justify-center items-center">
            ...
            <span className="text-center">
              Seu cadastro está quase completo. Realize a verificação do seu
              e-mail e finalize o seu cadastro e seu login será realizado{" "}
            </span>
            <button
